...
use event_bus::{
  EventMessage, IncomingEventProcessor, IncomingEventOutcome,
  ProcessingErrorClass,
};
use crate::{JetStreamConsumerError, NatsMessage, SettlementAction};
...
impl JetStreamIncomingConsumer {
  ...
  pub async fn handle(&self, delivery: NatsMessage) -> Result<(), JetStreamConsumerError> {
